...
const InfoSection: React.FC<InfoSectionProps> = ({
  ...
  return (
    ...
    >
      <div className="min-w-[308px] max-w-[425px] h-full m-auto lg:m-initial">
      ...
      <div className="flex flex-col justify-start space-y-2 pt-5 lg:pt-14 bg-[#242424] max-w-full min-h-full">
        ...
        {subtitle && <div className="lg:text-xl px-5 lg:px-10">{subtitle}</div>}
        <p className="flex-grow text-xl pt-8 px-5 lg:p-10">{description}</p>
